...
<body>
    ...
    <div class="regform">
        <h2>INPUT FORMULIR ASESMEN AWAL</h2>
    </div>
    <div class="main1">
        <form action="inputdb.php" class="icalonppks" method="post" enctype="multipart/form-data">
            <table>
                ...
                <tr>
                    ...
                    <td><input type="number" name="usia" class="field2">
                    <td class="year">)*Tahun</td>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="number" name="no_kartu" class="field">
                    <td class="nk">)*Opsional</td>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="number" name="jumlah_tanggungan" class="field2">
                    <td class="year2">)*Orang</td>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="number" name="lama_dirawat" class="field2">
    ...
    color: #FFFFFF; width:90px; height:60px; font-size:20px; font-weight: bold;" class="button" value="Simpan" type="submit" id="submit" name="submit">
                </tr>
            </table>
        </form>
    </div>
