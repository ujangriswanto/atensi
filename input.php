...
<body>
            ...
            <form action="inputdb.php" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-75">
                        ...
                        <input type="number" name="jumlah_obat" placeholder="Jumlah" class="ml-1 mt-2">
                    </div>
                </div>
                <div class="row">
                    <div class="col-25">
    ...
    <!-- alert ketika data tidak masuk golongan apapun -->
    <?php if(@$_SESSION['gagal']){ ?>
        <script>
            Swal.fire("Selamat!", "<?php echo $_SESSION['gagal']; ?>", "success")
        </script>
    <?php unset($_SESSION['gagal']);}?>

    <!-- alert ketika terdapat data NIK dan no_kk yang sama -->
